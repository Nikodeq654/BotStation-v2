        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-sm text-silver2 hover:text-white transition-colors mb-2"
            >
            ...
            <p className="text-sm text-silver2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-accent2 hover:text-white transition-colors"
              >
                Kanał wsparcia
              </a>
            </p>
